...
{
    /// <summary>
    /// Represents a single cash-flow statement for a reporting period.
    /// </summary>
    public sealed class CashFlowData
    {
        ...
        /// <summary>
        /// Gets or sets the begin-period cash flow (currency).
        /// </summary>
        public double? BeginPeriodCashFlow { get; set; }

        /// <summary>
        /// Gets or sets the end-period cash flow (currency).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the cash and cash equivalents changes (currency).
        /// </summary>
